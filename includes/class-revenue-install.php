...
class Revenue_Install
{
	...
	public function create_campaigns_table()
	{
		...
		$sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}revenue_campaigns` (
            ...
            `campaign_status` varchar(255) NOT NULL default 'publish',
            `campaign_type` varchar(255) NOT NULL,
            `campaign_placement` varchar(255) NOT NULL,
            `campaign_behavior` varchar(255) NOT NULL default 'cross_sell',
            `campaign_recommendation` varchar(255) NOT NULL default 'manual',
            `campaign_inpage_position` varchar(255),
            `campaign_display_style` varchar(255),
            `campaign_trigger_type` varchar(255),
            `campaign_trigger_relation` varchar(255),
            `campaign_start_date_time` datetime,
            `campaign_end_date_time` datetime,
            PRIMARY KEY (id),
            KEY type_status_date (campaign_type,campaign_status,date_created,id),

jQuery(document).ready(function($) {
    ...
    function showPopup(animationType) {
        ...
        switch (animationType) {
            ...
            case 'vibrate':
                ...
                break;
            case 'flash':
                $popup.css({ display: 'block' , animationDuration: "1s"}).addClass('flash');
                break;
            default:
                $popup.show();
                break;
    ...
    function hidePopup(animationType) {
        switch (animationType) {
            case 'fade':
                ...
                break;
            case 'zoom':
                $popup.removeClass('zoom-in').addClass('zoom-out').one('animationend', function() {
            ...
            case 'slide':
                ...
                break;
            case 'bounce':
                $popup.removeClass('bounce-in').addClass('bounce-out').one('animationend', function() {
            ...
            case 'flash':
                ...
                $popup.removeClass('flash').addClass('flash-out').one('animationend', function() {
    ...
    setTimeout(function() {
        ...
        $('.revx-popup__content.revx-normal-discount-grid .revx-slider-container').each(function () {
            initializeSlider($(this),'normal_discount');
        });
        $('.revx-popup__content.revx-bundle-discount-grid .revx-slider-container').each(function () {
        ...
        $('.revx-popup__content.revx-mix-match-grid .revx-slider-container').each(function () {
	...
	$(document).on('revx_added_to_cart', `.revx-campaign-${$campaignID}`, function() {
		hidePopup(animationType); // Change animationType to the desired animation type
	});
